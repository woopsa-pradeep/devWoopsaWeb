      ...
      <div style={{ marginTop: '80px', minHeight: 'calc(100vh - 80px - 200px)' }}>
        <Container maxWidth="lg" sx={{ py: 6 }}>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" sx={{ mb: 1, lineHeight: 1.7, color: '#555', ml: 2 }}>
              • <strong>Application</strong> refers to WOOPSA – Jamison Computer Systems Inc., the software program provided by the Company.
            </Typography>
            <Typography variant="body1" sx={{ mb: 1, lineHeight: 1.7, color: '#555', ml: 2 }}>
              • <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to WOOPSA – Jamison Computer Systems Inc.
            </Typography>
            <Typography variant="body1" sx={{ mb: 1, lineHeight: 1.7, color: '#555', ml: 2 }}>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.7, color: '#555' }}>
              By email: support@woopsamarketplace.com
            </Typography>
          </Box>
        </Container>
      </div>
