...
import { Box, Paper, Typography, useTheme, useMediaQuery, Tabs, Tab } from '@mui/material';
  ...
  if (loading) {
    return (
      <Box display="flex" justifyContent="center" alignItems="center" height="400px">
        <Typography>Loading Epick settings...</Typography>
      </Box>
    );
  }
      ...
      <Box display="flex" flexDirection={{ xs: "column", md: "row" }} mt={2} gap={3} height="calc(100vh - 210px)">
        ...
        <Paper sx={{ width: { xs: "100%", md: 250 }, borderRadius: 3, boxShadow: "none" }}>
          ...
          >
            <Tab
              label="Pin Settings"
              icon={<img src={epickSettingIcon} alt="Pin Settings" style={{ width: 20, height: 20 }} />}
              iconPosition="start"
              sx={{
                alignItems: "center",
