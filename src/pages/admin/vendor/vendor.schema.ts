...
export const vendorSchema = z.object({
  ...
  PrepaidTax_Calculation_Select: z.coerce.string(),
  MSA_Status: z.string(),
  ...
  QB_TaxVendor: z.coerce.string(),
  OTP_TaxReverseOnEntry: numberOrStringNumber(0),
  Buyer_ID: z.coerce.string(),
